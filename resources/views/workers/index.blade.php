...
@section('content')
    ...
    @foreach ($workers as $worker)
        ...
        <div class="modal fade" id="editWorkerModal{{ $worker->id }}" tabindex="-1"
            aria-labelledby="editWorkerModalLabel{{ $worker->id }}" aria-hidden="true">
            <div class="modal-dialog modal-lg" style="margin-top: 80px;">
                <div class="modal-content" style="background-color: rgb(104, 151, 115); border: 2px solid rgb(80, 116, 88);">
                        ...
                        <div class="modal-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="name" id="name{{ $worker->id }}" class="form-control"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="email" name="email" id="email{{ $worker->id }}" class="form-control"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="phone" id="phone{{ $worker->id }}" class="form-control"
                                        value="{{ old('phone', $worker->phone) }}" required>
                                </div>

                                <!-- Data de Contratação -->
                                <div class="col-md-6">
                                    <label for="hire_date{{ $worker->id }}" class="form-label text-white">Data de
                                        Contratação:</label>
                                    <input type="date" name="hire_date" id="hire_date{{ $worker->id }}" class="form-control"
                                        value="{{ old('hire_date', $worker->hire_date) }}" required>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal fade" id="deleteWorkerModal{{ $worker->id }}" tabindex="-1"
            aria-labelledby="deleteWorkerModalLabel{{ $worker->id }}" aria-hidden="true">
