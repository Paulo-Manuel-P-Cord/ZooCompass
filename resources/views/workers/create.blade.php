...
<div class="container mt-4">
    <h1 class="mb-4">Criar Novo Trabalhador</h1> <!-- Título -->
    ...
    <form action="{{ route('workers.store') }}" method="POST" class="row g-3">
        ...
        <div class="col-md-6">
            ...
            <input 
                ...
                value="{{ old('email') }}" 
                class="form-control" 
                placeholder="Digite o email do trabalhador" 
                required>
        </div>
        ...
        <div class="col-md-6">
            ...
            <input 
                ...
                value="{{ old('phone') }}" 
                class="form-control" 
                placeholder="Digite o telefone do trabalhador" 
                required>
        </div>
        ...
        <div class="col-12 text-end">
            <button type="submit" class="btn btn-success">
                <i class="bi bi-check-circle"></i> Criar Trabalhador
            </button>
