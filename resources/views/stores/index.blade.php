            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div>
                        ...
                        <button class="btn btn-success rounded-pill me-2" data-bs-toggle="modal"
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            ...
                                            <button type="button" class="btn btn-outline-success btn-sm rounded-pill"
                                                data-bs-toggle="modal" data-bs-target="#editStoreModal{{ $store->id }}">
                                                <i class="bi bi-pencil"></i> Editar
                                            </button>

                                            <!-- Botão Deletar -->
                                            <button type="button" class="btn btn-outline-danger btn-sm rounded-pill"
                                                data-bs-toggle="modal" data-bs-target="#deleteStoreModal{{ $store->id }}">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="amount" id="amount" class="form-control"
                                        value="{{ old('amount', $store->amount) }}" required>
                                </div>
