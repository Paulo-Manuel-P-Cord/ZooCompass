        ...
        <form action="{{ route('animals.update', $animal->id) }}" method="POST" class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="animal" id="animal" value="{{ old('animal', $animal->animal) }}"
                    class="form-control" placeholder="Digite o nome do animal" required>
            </div>
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="habitat" id="habitat" value="{{ old('habitat', $animal->habitat) }}"
                    class="form-control" placeholder="Digite o habitat do animal" required>
            </div>
            ...
            <div class="col-md-3">
                ...
                <input type="text" name="origin" id="origin" value="{{ old('origin', $animal->origin) }}"
                    class="form-control" placeholder="Digite a origem" required>
            </div>
