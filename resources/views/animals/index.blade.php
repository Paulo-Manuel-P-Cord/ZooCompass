...
@section('content')
    ...
    @foreach ($animals as $animal)
        ...
        <div class="modal fade" id="deleteAnimalModal{{ $animal->id }}" tabindex="-1"
            aria-labelledby="deleteAnimalModalLabel{{ $animal->id }}" aria-hidden="true">
    ...
    @foreach ($animals as $animal)
        <!-- Modal de Edição -->
        <div class="modal fade" id="editAnimalModal{{ $animal->id }}" tabindex="-1"
            aria-labelledby="editAnimalModalLabel{{ $animal->id }}" aria-hidden="true">
                        ...
                        <div class="modal-body">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="animal" id="animal{{ $animal->id }}" class="form-control"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="habitat" id="habitat{{ $animal->id }}" class="form-control"
                                        value="{{ $animal->habitat }}" required>
                                </div>
                                <div class="col-md-3">
                                    <label for="amount{{ $animal->id }}" class="form-label">Quantidade:</label>
                                    <input type="number" name="amount" id="amount{{ $animal->id }}" class="form-control"
                                        value="{{ $animal->amount }}" required>
                                </div>
                                <div class="col-md-3">
                                    <label for="origin{{ $animal->id }}" class="form-label">Origem:</label>
                                    <input type="text" name="origin" id="origin{{ $animal->id }}" class="form-control"
                                        value="{{ $animal->origin }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
