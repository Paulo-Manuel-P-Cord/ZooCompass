                    ...
                    <tbody>
                        @forelse ($positions as $position)
                            <tr>
                                ...
                                <td>
                                    <!-- Botão de editar -->
                                    <button type="button" class="btn btn-outline-success btn-sm rounded-pill" data-bs-toggle="modal" data-bs-target="#editPositionModal{{ $position->id }}">
    <i class="bi bi-pencil"></i> Editar
</button>

                                    <!-- Botão de deletar -->
                                    <!-- Botão para abrir o modal de exclusão -->
<button type="button" class="btn btn-outline-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deletePositionModal{{ $position->id }}">
