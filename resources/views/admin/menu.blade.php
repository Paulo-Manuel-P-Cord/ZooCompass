...
@section('content')
    ...
    <div class="container">
        <!-- Título Principal -->
        <h1 class="w-100 my-4 py-3 bg-gradient text-white text-center display-3 rounded-4 shadow-lg">Painel de Administração
        </h1>
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="card shadow-lg border-success rounded-3 mb-4">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('workers.index') }}" class="btn btn-outline-success rounded-pill">Acessar
                                        Trabalhadores</a>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="card shadow-lg border-success rounded-3">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('stores.index') }}" class="btn btn-outline-success rounded-pill">Acessar
                                        Estoque</a>
                                </div>
                            </div>
                            ...
                            <div class="card shadow-lg border-success rounded-3 mt-3">
                                <div class="card-body">
                                    ...
                                    <h5 class="text-muted">Total de Categorias de Estoque: {{ $modules[4]['data']['total_categories'] }}
                                    </h5>
                                    <a href="{{ route('stock_categories.index') }}" class="btn btn-outline-success rounded-pill">Acessar
                                        Categorias</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card shadow-lg border-success rounded-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">{{ $module['description'] }}</p>
                                <a href="{{ $module['route'] }}" class="btn btn-outline-success rounded-pill">Acessar
                                    Manutenções</a>
                            </div>
                        </div>
                        <div class="card shadow-lg border-success rounded-3 mt-3">
