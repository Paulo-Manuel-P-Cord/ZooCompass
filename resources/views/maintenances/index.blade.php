        ...
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div>
                    ...
                    <button class="btn btn-success rounded-pill" data-bs-toggle="modal" data-bs-target="#createMaintenanceModal">
                    ...
                    <tbody>
                        @forelse ($maintenances as $maintenance)
                            <tr>
                                ...
                                <td><span class="badge bg-success">R$ {{ number_format($maintenance->cost, 2, ',', '.') }}</span></td>
                                <td>
                                ...
                                <td>
                                    {{-- Botão Editar --}}
                                    <button class="btn btn-outline-success btn-sm rounded-pill" data-bs-toggle="modal" data-bs-target="#editMaintenanceModal{{ $maintenance->id }}">
    <i class="bi bi-pencil"></i> Editar
</button>

                                    {{-- Botão Deletar --}}
                                    <button class="btn btn-outline-danger btn-sm rounded-pill" data-bs-toggle="modal" data-bs-target="#deleteMaintenanceModal{{ $maintenance->id }}">
...
<div class="modal fade" id="deleteMaintenanceModal{{ $maintenance->id }}" tabindex="-1" aria-labelledby="deleteMaintenanceModalLabel{{ $maintenance->id }}" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border border-danger">
            ...
            <div class="modal-body">
                Tem certeza que deseja excluir a manutenção <strong>"{{ $maintenance->description }}"</strong> do dia <strong>{{ \Carbon\Carbon::parse($maintenance->date)->format('d/m/Y') }}</strong>?
                <br>
