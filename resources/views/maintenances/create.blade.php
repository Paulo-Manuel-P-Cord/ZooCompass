    ...
    <div class="container mt-4">
        ...
        <form action="{{ route('maintenances.store') }}" method="POST" class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="number" name="cost" id="cost" class="form-control" placeholder="Digite o custo da manutenção"
                    required>
            </div>
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="type" id="type" class="form-control" placeholder="Digite o tipo da manutenção"
                    required>
            </div>
